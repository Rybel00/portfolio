    ...
    return (
        ...
        className="p-4 -m-4">
            ...
            transition-transform hover:border-white duration-300 shadow-lg shadow-lg backdrop-blur-lg project-card">
                <a href="">
                    <img src={Arduino} alt="project-img"
                    className="lg:h-fill w-full object-cover object-center"/>
                </a>
                <div className="p-4 flex flex-col lg:gap-3">
                    <h2 className="tracking-widest text-2xl text-white font-bold">Ultrasonic Radar Detection System</h2>
                    <h1 className="text-lg lg:text-lg text-gray-300">An arduino project in development.</h1>
                </div>
            </div>
        </div>
    );
